...
const BlogPost: React.FC<{ slug?: string }> = ({ slug }) => {
    ...
    useEffect(() => {
        // Dynamic SEO changes
        document.title = "Luxury Shortlet in Asaba (2026 Guide) | Umunna Stays";
        const metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc) {
            metaDesc.setAttribute("content", "Stay in premium serviced apartments in Asaba with concierge, 24/7 power, airport pickup & executive comfort. Book Umunna Stays today.");
        }
    }, []);
    ...
    return (
        ...
        `}} />
                ...
                <div className="text-center mb-10">
                    <div className="text-sm font-semibold text-brand tracking-wider uppercase mb-4">Luxury Apartments Asaba</div>
                    <h1 className="text-4xl md:text-5xl font-bold text-charcoal mb-6 leading-tight">
                        Luxury Shortlet in Asaba (2026 Guide) | Umunna Stays
                    </h1>
                ...
                <div className="w-full h-96 bg-gray-200 rounded-xl overflow-hidden mb-12">
                    <img
                        ...
                        alt="Luxury shortlet apartment in Asaba with concierge service"
