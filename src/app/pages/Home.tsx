...
import PropertyCarousel from '../../stays/components/PropertyCarousel';
import ConciergeLeadForm from '../../concierge/components/ConciergeLeadForm';
import { Search, ChevronRight, ArrowRight, ShieldCheck, Zap, Wifi, Droplets, AlertTriangle, Star, MapPin } from 'lucide-react';
import ServiceHeroCarousel from '../../shared/ui/ServiceHeroCarousel';
import LeadCapturePopup from '../../shared/ui/LeadCapturePopup';
import nateImg from '../../assets/nate-signature-hero.jpg';
import foodImg from '../../assets/rice-chicken.png';
import transportImg from '../../assets/land-cruiser.png';
import { motion, useScroll, useTransform } from 'framer-motion';
import { BlogPostData } from '../../../blogData';
import { fetchBlogPosts, fetchBlogPostBySlug } from '../../cms/services/blogService';
...
const Home: React.FC<HomeProps> = ({ onNavigate, appData }) => {
  ...
  useEffect(() => {
    document.title = "Umunna Stays | 24/7 Power Short Lets & Secure Logistics";
            ...
            {(mainServices || []).map((service, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold font-heading mb-4">{service.name ?? "Exclusive Service"}</h3>
                  <p className="text-gray-400 mb-8 min-h-[48px] line-clamp-2">{service.description ?? "Curated logistics for Umunna guests."}</p>
                  <a
                    href={`https://wa.me/${appData.meta.whatsapp_main_number}?text=${encodeURIComponent(service.whatsapp_prefill || "Hello, I'm interested in your concierge services.")}`}
