          ...
          {properties.map((property, idx) => (
            ...
            >
              <PropertyCard 
                ...
                appData={appData} 
                onClick={(p) => {
                  console.log("PropertyCarousel onClick wrapper called for:", p.property_id, "hasMoved:", hasMoved);
                  if (!hasMoved) {
                    console.log("Calling onNavigate('property-detail') for:", p.property_id);
                    onNavigate('property-detail', p);
                  } else {
                    console.log("Skipped calling onNavigate because hasMoved was true!");
                  }
                }} 
              />
            </div>
