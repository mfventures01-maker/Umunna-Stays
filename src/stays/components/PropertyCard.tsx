    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex flex-col gap-3">
          <button
            onClick={(e) => {
              console.log("PropertyCard Details button onClick triggered for:", property.property_id);
              e.stopPropagation();
              onClick(property);
            }}
          ...
          <a
            href={`${whatsappBase}?text=${encodeURIComponent(`Hello, I'm interested in ${property.name} (${property.property_id}). Please render assistance.`)}`}
            target="_blank"
            rel="noopener noreferrer"
            onClick={(e) => e.stopPropagation()}
